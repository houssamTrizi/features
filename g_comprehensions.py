...
# C-style
high_measurement1 = []  # all with value over 70
for m in measurements:
    if m.value > 70:
        high_measurement1.append(m.value)

# list comprehension
high_measurement2 = [m.value for m in measurements if m.value > 70]

# generator expression
high_measurement_gen = (m.value for m in measurements if m.value > 70)



# process the generator to get something printable.

high_measurement4 = list()

if __name__ == '__main__':
    print(high_measurement1)
    print(high_measurement2)
    print(high_measurement3)
